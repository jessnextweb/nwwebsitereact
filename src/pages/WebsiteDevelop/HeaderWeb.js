...
import HeaderSoftware from "./HeaderWebsite";
import ContentSoftware from "./ContentWebsite";
import ChooseSoftware from "./ChooseWebsite";
import SupportSoftware from "./SupportWebsite";
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="mx-auto" id="webnavbar">
              ...
              <Nav.Link href="/emertech">
                <FaRocket className="me-2" /> Emerg.Tech
              </Nav.Link>
            </Nav>
          </Navbar.Collapse>
        </Container>
