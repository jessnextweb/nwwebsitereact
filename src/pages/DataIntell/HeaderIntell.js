            ...
            <Row>
              ...
              <Col lg={6} md={6} sm={12}>
                <h2 className="mt-5 pt-5 deliver text-white">
                  Data Intelligence Services Australia
                </h2>
                <div
                ...
                >
                  ...
                  >
                    At Nextweb, we specialize in Data Intelligence Services,
                    offering tailored solutions to meet the needs of businesses
                    across Australia. As local experts in Data Intelligence and
                    Management Services, we understand the critical role that
                    well-managed data plays in decision-making, operational
                    efficiency, and overall business success. In today’s
                    data-driven world, organizations must leverage reliable data
